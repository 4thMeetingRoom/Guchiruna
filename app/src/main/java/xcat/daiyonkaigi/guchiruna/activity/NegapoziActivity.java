...
public class NegapoziActivity extends Activity implements View.OnClickListener {
    ...
    final SolidColor COLOR_BACK_GROUND = new SolidColor(Color.rgb(0, 0, 102));
    final SolidColor COLOR_WHITE = new SolidColor(Color.rgb(255, 255, 255));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu.findViewById(R.id.negapozi).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                //次画面での表示処理
                Intent negaIntent = new Intent(NegapoziActivity.this, NegapoziActivity.class);
        ...
        menu.findViewById(R.id.tweet).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                View menu = findViewById(R.id.menu_layout);
                ImageButton rankButton = (ImageButton) menu.findViewById(R.id.tweet);
                rankButton.setOnClickListener(this);
                //次画面での表示処理
                Intent rankIntent = new Intent(NegapoziActivity.this, InputActivity.class);
        ...
        menu.findViewById(R.id.timeline).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                //次画面での表示処理
                Intent timeIntent = new Intent(NegapoziActivity.this, TimelineActivity.class);
    ...
    private void createGraph(){
        ...
        currentMonth.setText(this.YEAR+"年"+this.MONTH + "月");
        ...
        //*** 背景の色 ******
        chart.setBackgroundPaintType(COLOR_BACK_GROUND);
        //*** 枠線の色 ******
        chart.setBorderPaintType(COLOR_BACK_GROUND);
        XYPlot plot = (XYPlot) chart.getPlot();
        //*** グラフ領域の背景とY軸を黒にする *****
        plot.setBackgroundPaintType(COLOR_BACK_GROUND);
        plot.setDomainGridlinePaintType(COLOR_BACK_GROUND);
        // *** Y軸の目盛間隔とフォントの変更
        ValueAxis yAxis = plot.getRangeAxis();
        yAxis.setLabelPaintType(COLOR_WHITE);
        ...
        xAxis.setLabelPaintType(COLOR_WHITE);
        ...
        legend.setItemPaintType(COLOR_WHITE);
    ...
    private void createPieChart(){
        ...
        leg.setBackgroundPaintType(COLOR_BACK_GROUND);
        leg.setItemPaintType(COLOR_WHITE);
    ...
    private void createAllGraph(){
        ...
        //title.setFont(new Font(Typeface.SANS_SERIF, Typeface.BOLD, 44));
        //chart.setTitle(title);
        currentMonth.setText(this.YEAR + "年");

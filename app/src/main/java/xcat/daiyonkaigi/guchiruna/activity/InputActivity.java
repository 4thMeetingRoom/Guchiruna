...
public class InputActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu.findViewById(R.id.negapozi).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                //次画面での表示処理
                Intent negaIntent = new Intent(InputActivity.this, NegapoziActivity.class);
        ...
        menu.findViewById(R.id.tweet).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                //次画面での表示処理
                Intent rankIntent = new Intent(InputActivity.this, InputActivity.class);
        ...
        menu.findViewById(R.id.timeline).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                //次画面での表示処理
                Intent timeIntent = new Intent(InputActivity.this, TimelineActivity.class);
                startActivity(timeIntent);
            }
        });

        //ボタン押下時の登録処理
        Button confirmButton = (Button) this.findViewById(R.id.save);
        confirmButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!"".equals(article) && null != article) {
                    ...
                    //ネットワークの接続状況を判定し、接続なしの場合は判定を行わない
                ...
                //次画面での表示処理
                Intent rankIntent = new Intent(InputActivity.this, TimelineActivity.class);
                startActivity(rankIntent);
            }
        });
    }
     ...
     *  削除していただいても結構です。
     */
    private void createNegapoziData() {
        // 現在日時の取得
